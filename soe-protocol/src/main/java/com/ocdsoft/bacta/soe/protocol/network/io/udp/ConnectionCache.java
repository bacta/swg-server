...
public final class ConnectionCache {
    ...
    @Inject
    public ConnectionCache(final SharedNetworkConfiguration networkConfiguration, final GaugeService gaugeService) {
    ...
    public void put(final InetSocketAddress remoteAddress, final SoeUdpConnection connection) {
        ...
        gaugeService.submit("soe.connections.active-connections", connectionMap.size());
