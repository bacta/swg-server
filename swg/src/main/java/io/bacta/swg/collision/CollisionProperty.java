...
public class CollisionProperty extends Property {
    ...
    public CollisionProperty(final GameObject owner) {
        this(owner, owner.getObjectTemplate());
    }

    public CollisionProperty(final GameObject owner, final ObjectTemplate objectTemplate) {
        ...
        //TODO: Fix init. This will have to be done in a class on the server.
